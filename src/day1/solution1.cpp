...
int Solution1::handle_line(std::string const& line)
{
...
int Solution1::handle_lines(std::vector<std::string> const& lines)
{
	int sum = 0;
...
static const std::regex number_regex("(one)|(two)|(three)|(four)|(five)|(six)|(seven)|(eight)|(nine)");

// [part 2] transforms written numbers to digits
std::string Solution1::transform_written_numbers(std::string const& line)
{
...
std::vector<std::string> Solution1::transformed_written_numbers(std::vector<std::string> const& lines)
{
