...
namespace day1
{
	...
	TEST_F(Tests, SolutionPart1) {
		EXPECT_EQ(55002, s.handle_lines(read_lines("./src/day1/input/input.txt")));
	}
	TEST_F(Tests, SolutionPart1Example1) {
		EXPECT_EQ(142, s.handle_lines(read_lines("./src/day1/input/example1.txt")));
	}
	...
	TEST_F(Tests, SolutionPart2Example2) {
		EXPECT_EQ(281, s.handle_lines(s.transformed_written_numbers(read_lines("./src/day1/input/example2.txt"))));
	}
	TEST_F(Tests, SolutionPart2) {
		EXPECT_EQ(55093, s.handle_lines(s.transformed_written_numbers(read_lines("./src/day1/input/input.txt"))));
	}
}
